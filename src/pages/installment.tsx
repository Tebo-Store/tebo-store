    ...
    <>
      ...
      <Container className="py-10 2xl:py-12 checkout">
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-5 xl:max-w-screen-xl mx-auto ">
          {!!installmentData ? <> <div className="mb-5 lg:mb-0 lg:w-8/12">
            ...
            <div className="space-y-4">
              ...
              <div className="md:flex md:justify-between space-y-4 md:space-y-0 md:space-x-4">
                <Input
                  id="fullName"
                  label='Имя и фамилия'
                  type='text'
            ...
            <div className="space-y-4 lg:w-4/12">
              ...
              <div className="flex justify-between items-center space-x-4 lg:items-start">
                <span className="text-xs md:text-base lg:w-5/12">Срок рассрочки</span>
              ...
              <div className="flex justify-between items-center space-x-4 lg:items-start">
                <span className="text-xs md:text-base lg:w-5/12">Первоначальный взнос</span>
                <span className="text-sm md:text-lg font-semibold text-right">
              ...
              <div className="flex justify-between items-center space-x-4 lg:items-start">
                <span className="text-xs md:text-base lg:w-5/12">Ежемесячный платеж</span>
                <span className="text-sm md:text-lg font-semibold text-right">
              ...
              <div className="flex justify-between items-center space-x-4 lg:items-start">
                <span className="text-xs md:text-base lg:w-5/12">Общая сумма рассрочки</span>
                <span className="text-sm md:text-lg font-semibold text-right">
              ...
              }} className="w-full" variant='formButton'>
                Оформить заказ
              </Button>
            </div>
          </>
            ...
            <div className="mx-auto md:max-w-[400px]">
              <h2 className='text-2xl font-bold text-center'>Выберите товар для оформления заказа в рассрочку</h2>

              <Button className="w-full mt-5" onClick={() => router.push('/')}>На главную</Button>
            </div>
          }
