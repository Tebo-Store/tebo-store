    ...
    >
      ...
      <div className="flex flex-col px-3 md:px-4 lg:px-[18px] pb-5 lg:pb-6 lg:pt-1.5 h-full">
        ...
        <div className="flex flex-col flex-grow justify-end">
          <button className="mb-2 text-sm py-2 px-4 bg-skin-inverted text-skin-base border border-skin-four active:bg-skin-four rounded font-semibold cursor-pointer transition ease-in-out duration-300">
            В один клик
          </button>
          <button onClick={handlePopupView} className="text-sm py-[9px] px-4 bg-skin-primary text-skin-inverted hover:bg-opacity-90 active:bg-opacity-90 rounded font-semibold cursor-pointer transition ease-in-out duration-300">
            В рассрочку
          </button>
        </div>
      </div>
